...
def test_software_agent():
    ...
    assert software.model_dump(by_alias=True) == data
...
def test_organization_agent():
    ...
    assert organization.model_dump(by_alias=True) == data
...
def test_website():
    ...
    assert website.model_dump(by_alias=True) == data
...
def test_provenance():
    ...
    assert provenance.model_dump(by_alias=True) == data
...
def test_create_objects():
    ...
    assert organization.model_dump(by_alias=True) == cmp_dict
    ...
    assert software.model_dump(by_alias=True) == cmp_dict
    ...
    assert person.model_dump(by_alias=True) == cmp_dict
    ...
    assert cmp_dict == provenance.model_dump(by_alias=True)
